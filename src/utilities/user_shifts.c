...
/*
** These functions drive the mouse movement and zoom in on mouse function.
** Button 5 is a move outward with the mouse zoom. Button 4 is the opposite.
** Fractal zoom uses a similar method but because of the drastically different
** rendering process slight adjustments had to be taken to account for rounding
*/
