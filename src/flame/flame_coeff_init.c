...
/*
** These functions set all the coefficent values, which will drive the
** transformations. There are three key conditions to check: a^2 + d^2 < 1
** b^2 + e^2 < 1 and a^2 + b^2 + d^2 + e^2 i < 1 + (ae - bd)^2.
*/
